...
* [Figure 1](#figure-topic-distribution-*) shows a right-skewed distribution, with most topics containing few photographs and a small number of large topics dominating.*
...
* The curve in [Figure 2](#figure-cumulative-distribution-*) shows that a small number of large topics make up a disproportionate share of all classified photographs.*
...
An analysis of the content within individual topics reveals distinct tendencies of visual focus. The top ten topics are delineated in [Table 1](#table-ten-topics-*), demonstrating consistent themes predominantly centered on governmental authority and civic life.
...
* The nine most representative photographs from this cluster ([Figure 3](#figure-representative-images-*)) illustrate the standardised visual language of desk portraits.*
...
* In [Figure 4](#figure-topic1-images-*), the photographs depict military personnel in formal formations and official functions.*
...
* In [Figure 5](#figure-topic2-images-*): Formal meetings, treaty signings, and committee proceedings characterize this cluster.*
...
* [Figure 6](#figure-topic5-images-*) shows standardised documentation of residential architecture across the capital.*
...
* In [Figure 7](#figure-topic-distribution-noise-*), nearly a quarter of all photographs resist topical categorisation.*
...
* In [Figure 8](#figure-images-noise-*), the photographs resist topical categorisation, demonstrating the diversity of content that falls outside the collection's dominant visual logics.
...
* Florence-2 incorrectly identifies the signage in [Figure 9](#FIGURE-bank-marlborough-*) as "Bank of America," demonstrating how vision-language models struggle with historical images containing period-specific text and unfamiliar institutional names.*
